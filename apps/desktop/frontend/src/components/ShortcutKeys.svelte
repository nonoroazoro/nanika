...
.separator { display: inline-flex; width: 0.5rem; height: 1.25rem; align-items: center; justify-content: center; color: var(--text-tertiary); font-size: 0.6875rem; font-weight: 500; line-height: 1; transition: color 180ms ease; }
